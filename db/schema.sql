...
create index if not exists lists_user_created_idx on lists (user_id, created_at desc);
...
create index if not exists list_words_word_id_idx on list_words (word_id);
create index if not exists list_words_list_id_created_idx on list_words (list_id, created_at desc);
